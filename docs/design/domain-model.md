...
> 状态：🟡 Draft  
> 最后更新：2026-05-14  
> 来源：[`unified-design-v0.4.md §12`](unified-design-v0.4.md) 抽出并扩展  
...
> 🆕 标记的字段是**对 v0.4 的补充**，用于崩溃恢复，见 [`replay-and-recovery.md`](replay-and-recovery.md)。
...
| 日期 | 变更 |
|---|---|
| 2026-05-14 | 初版，从 v0.4 §12 抽出并补充 heartbeat/lease 字段 |

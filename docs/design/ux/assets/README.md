...
| 文件                                                                          | 类型        | 来源                    | 用途                              |
| ----------------------------------------------------------------------------- | ----------- | ----------------------- | --------------------------------- | --- | ------------------------------------------------------------------------------ | ----------- | ----------------------- | ------------------ | --- | -------------------------------------------------------------------------------- | ----------- | ----------------------- | ---------------- | --- | ------------------------------------------------------------------------------------ | ----------- | ----------------------- | ------------------ | --- | ---------------------------------------------------------------------------------- | ----------- | ----------------------- | -------------- |
| [`desktop-first-launch.svg`](wireframes/desktop-first-launch.svg)             | 低保真线框  | 手写 SVG                | First Launch 信息结构             |
| [`desktop-home.svg`](wireframes/desktop-home.svg)                             | 低保真线框  | 手写 SVG                | Home / Inbox 信息结构             |
| [`desktop-run-detail.svg`](wireframes/desktop-run-detail.svg)                 | 低保真线框  | 手写 SVG                | Run Detail 信息结构               |
| [`desktop-runtime-status.svg`](wireframes/desktop-runtime-status.svg)         | 低保真线框  | 手写 SVG                | Runtime Status 信息结构           |
| [`ui-v1-home-inbox.svg`](visual-v1/ui-v1-home-inbox.svg)                      | 视觉参考 V1 | 手写 SVG，未使用 image2 | Home / Inbox 视觉方向             |
...
| [`ui-v1-common-components-zh.svg`](components/ui-v1-common-components-zh.svg) | 视觉参考 V1 | 手写 SVG，未使用 image2 | 常用组件统一设计总览              |

## 约定

- 当前 V1 不是最终 UI，不代表最终 spacing、色板或组件 API。
- 视觉参考图优先表达产品气质与信息密度：本地优先、工程控制台、证据链、人类接管。
- 如后续使用 image2 / Figma / Sketch / 其他图像工具，应在本文件记录来源、版本、prompt 或设计说明。

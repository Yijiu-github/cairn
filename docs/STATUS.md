...
| `apps/desktop`              | 8                | main module 非阻塞加载、bootstrap 顺序、sidecar manager、Workspace Core internal-trial client、renderer replay/payload/operator action loaders（含空 run id / 乱序防护）、Electron Vite config；另以 typecheck/lint/build 验证 |
